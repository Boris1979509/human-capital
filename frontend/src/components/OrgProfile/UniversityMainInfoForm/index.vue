    ...
    <section class="profile__section">
      ...
      <div class="row">
        ...
        <div class="col-50">
          <TextInput class="invert"
                     type="text"
                     placeholder="Средний проходной балл"
                     v-model="fields.avg_score"
                     :isLabel="false"
                     :required="true"
                     inputMask="#####"/>
        </div>
        ...
        <div class="col-50">
          <TextInput class="invert"
                     type="text"
                     placeholder="Средная зарплата выпускника"
                     v-model="fields.avg_salary"
                     :isLabel="false"
                     :required="true"
                     inputMask="#########"/>
        </div>
        ...
        <div class="col-50">
          <TextInput class="invert"
                     type="text"
                     placeholder="Процент трудоустройства"
                     v-model="fields.rate_employment"
                     :isLabel="false"
                     :required="true"/>
        </div>

        <div class="col-100">
          <Checkbox :id="'rating_show_students'"
                    label="Отображать рейтинг по мнению студентов"
                    :description="`Текущий рейтинг — ${fields.rating.personal}`"
                    :margin="24"
                    :checked="fields.show_rating_students"
                    @change="fields.show_rating_students = $event"
          />
        </div>

        <div class="col-100">
          <Checkbox :id="'rating_show_work'"
                    label="Отображать рейтинг по мнению работодателей"
                    :description="`Текущий рейтинг — ${fields.rating.employer}`"
                    :margin="24"
  ...
  data: function() {
    return {
      fields: {
        ...
        show_rating_students: false,
        show_rating_employers: false,
