...
class EventRegistrationRejectTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->endpoint = route('event-registrations.reject');
    }
    ...
    public function it_accepts_event_registration(): void
    {
        ...
        $response->assertOk();
        $this->assertEquals(EventRegistration::STATUS_REJECTED, $this->registration->fresh()->status);
    }
