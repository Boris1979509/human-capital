        ...
        <div class="col-50">
          <div class="btn btn--blue" @click="$router.push({
            name: 'InstitutionView',
              params: {
                id: fields.id,
                fromComponent: $route.name,
              }
            })">
            Как пользователь видит информацию
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-50">
          <Select :array="employment_assistance_data"
                  placeholder="Помощь в трудоустройстве"
                  :pre-selected="fields.employment_assistance"
                  @select="fields.employment_assistance = $event"/>
        </div>
